...
const LOGO_HEADER = `
<tr>
  <td style="background:#050f1e;padding:24px 36px;border-bottom:1px solid #1e2433;">
    <table cellpadding="0" cellspacing="0"><tr>
      <td style="background:#091524;border-radius:8px;width:36px;height:36px;text-align:center;vertical-align:middle;">
        <span style="color:#00AEEC;font-size:18px;">⚡</span>
      </td>
      <td style="padding-left:10px;">
        <span style="font-family:Arial,sans-serif;font-size:18px;font-weight:700;color:#e8eaf0;letter-spacing:-0.5px;">SparkLead</span>
      </td>
    </tr></table>
  </td>
</tr>`;
...
<tr>
  <td style="background:#0d1117;border:1px solid #1e2433;border-radius:8px;overflow:hidden;">
    <table cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td style="padding:8px 14px;background:#050f1e;border-bottom:1px solid #1e2433;">
